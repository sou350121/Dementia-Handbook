...
- **邏輯位置**：這是首篇將「環境聲學」與「腦部廢物清除 (Axis A)」在分子層面聯繫起來的研究。

## 2. 核心發現 (Core Clues)

### A. 睡眠結構的碎片化 (Sleep Fragmentation)
- **機制**：慢性城市噪音（即使在較低分貝下）會顯著縮短 **非快速眼動睡眠 (NREM)** 的深度，特別是慢波睡眠 (Slow-wave sleep)。
- **物理後果**：大腦的 **類淋巴系統 (Glymphatic System)** 在慢波睡眠期間流量最大。研究顯示，慢性噪音暴露組的 Aβ 清除速率下降了 **35%**。

### B. 腎上腺素能的神經調控
- **發現**：噪音誘導的微覺醒 (Micro-arousals) 會導致藍斑核 (Locus Coeruleus) 持續釋放 **去甲腎上腺素 (Norepinephrine)**。
- **線索 (Clue)**：高水平的去甲腎上腺素會關閉類淋巴系統的「排污門」，導致蛋白毒性物質在細胞間隙蓄積。

## 3. 跨軸線交互 (Cross-Axis Synergy)
- **Axis A 關聯**：噪音不是直接產生 Aβ，而是通過「抑制清除」來改寫聚合動力學曲線。
- **Axis C 關聯**：生活方式干預（如隔音睡眠環境）可能比單純的藥物清除更具預防價值。

## 4. 研究線索 (Research Clues)
- **生物標記**：夜間去甲腎上腺素水平是否能預測長期的認知退化風險？
- **干預實驗**：使用白噪音 (White Noise) 或粉紅噪音 (Pink Noise) 優化睡眠結構，能否逆轉環境噪音造成的清除障礙？
